    ...
    internal class CoffeeMachineActors
    {
        ...
        internal class FailoverDriver : Machine
        {
            ...
            internal void OnStartTest()
            {
                ...
                this.CoffeeMachineId = this.CreateMachine(typeof(CoffeeMachine), new CoffeeMachine.ConfigEvent(this.SensorsId, this.Id));

                // Request a coffee!
                var shots = this.RandomInteger(3) + 1;
                this.Send(this.CoffeeMachineId, new CoffeeMachine.MakeCoffeeEvent(shots));
            ...
            internal void OnStopTest()
            {
                ...
                else
                {
                    ...
                    this.Send(this.CoffeeMachineId, new CoffeeMachine.TerminateEvent());
                }
            }
